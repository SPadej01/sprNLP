...
"""
Override the MultiHeadAttention class with use of sigmoid with L1 normalization to calculate attention scores. 
"""
...
class MultiHeadSigmoidL1Attention(MultiHeadAttention):
    def __init__(
        ...
        def _compute_attention(
            ...
            """Applies Sigmoid similarity with L1 normalization attention between query, key, value tensors.
